...
<div class="modal fade" id="modalBorrarGrupo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="formBorrarGrupo" action="${pageContext.request.contextPath}/grupo?accion=remove2"
